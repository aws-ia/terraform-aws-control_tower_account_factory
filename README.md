...
| <a name="input_aft_vpc_interface_endpoints"></a> [aft\_vpc\_interface\_endpoints](#input\_aft\_vpc\_interface\_endpoints) | Flag turning VPC interface endpoints on/off for AFT VPC | `bool` | `true` | no |
| <a name="input_aft_vpc_gateway_endpoints"></a> [aft\_vpc\_gateway\_endpoints](#input\_aft\_vpc\_gateway\_endpoints) | Flag turning VPC gateway endpoints on/off for AFT VPC | `bool` | `true` | no |
