...
| <a name="input_create_ssm_block_public_sharing"></a> [create\_ssm\_block\_public\_sharing](#input\_create\_ssm\_block\_public\_sharing) | Whether to block public sharing of SSM documents in the AFT management account for the Control Tower home region. Addresses Security Hub control SSM.7. | `bool` | `true` | no |
