...
def setup_and_run_workspace(organization_name, workspace_name, assume_role_arn, role_session_name, api_token):

    workspace_id = setup_workspace(organization_name, workspace_name, assume_role_arn, role_session_name, api_token)
    run_id = stage_run(workspace_id,assume_role_arn, role_session_name, api_token)
    return run_id

def setup_workspace(organization_name, workspace_name, assume_role_arn, role_session_name, api_token):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--assume_role_session_name', type=str, help="IAM Role ARN to be used by the workspace")
    ...
    if args.operation == "delete":
        ...
        setup_and_run_workspace(args.organization_name, args.workspace_name, args.assume_role_arn, args.assume_role_session_name, args.api_token)